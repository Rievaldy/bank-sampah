...
public class SatuanAdapter extends RecyclerView.Adapter<SatuanAdapter.ViewHolder> {
    ...
    public SatuanAdapter(Context context, List<SatuanModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.textSatuan.setText(list.get(position).getNamaSatuan());
    ...
    public interface OnCallBack{
        void onTblHapus(SatuanModel satuanModel);
        void onTblEdit(SatuanModel satuanModel);
    }
}
