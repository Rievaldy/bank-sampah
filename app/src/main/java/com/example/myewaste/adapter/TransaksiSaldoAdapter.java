...
import com.example.myewaste.MasterTransaksiSaldoActivity;
...
public class TransaksiSaldoAdapter extends RecyclerView.Adapter<TransaksiSaldoAdapter.ViewHolder> {
    ...
    Context context;
    List<TransaksiSaldo> list;
    MasterTransaksiSaldoActivity.MasterSaldoListener listener;

    public TransaksiSaldoAdapter(Context context, List<TransaksiSaldo> list, MasterTransaksiSaldoActivity.MasterSaldoListener listener) {
