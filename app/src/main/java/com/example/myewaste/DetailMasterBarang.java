...
public class DetailMasterBarang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadImage(dataBarang.getFoto_master_barang(), ivDetailFotoBarang);
        tvDetailNamaBarang = (TextView) findViewById(R.id.tvDetailNamaBarang);
        tvDetailNamaBarang.setText(dataBarang.getNama_master_barang());
...
//            showConfirmDeleteDialog();
    ...
    void doEditBarang(){
        Intent intent = new Intent(DetailMasterBarang.this, TambahEditMasterBarang.class);
    ...
    void showConfirmDeleteDialog(){
        ...
        AlertDialog confirmationDeleteDialog = new AlertDialog.Builder(this)
                ...
                .setMessage("Apakah anda yakin ingin menghapus " + dataBarang.getNama_master_barang() + " ?")
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        databaseReference.child(dataBarang.getNo_master_barang()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
